...
public:
	...
	int countNodes();
	int countNodesHelper(BSTNode<T>*& p, int& total);
	
	int countLeafs();
	int countLeafsHelper(BSTNode<T>*& p, int& total);
	
	void reverseTree();
	void reverseTreeHelper(BSTNode<T>*& p);
...
int BST<T>::countNodes() {
	int total = 0;
	return countNodesHelper(root, total);
}

template<class T>
int BST<T>::countNodesHelper(BSTNode<T>*& p, int& total) {
	if( p == nullptr)
	   return total;
   
	total++;
	countNodesHelper(p->left, total);
	countNodesHelper(p->right, total);
}

template<class T>
int BST<T>::countLeafs() {
	int total = 0;
	return countLeafsHelper(root, total);
}

template<class T>
int BST<T>::countLeafsHelper(BSTNode<T>*& p, int& total) {
	if(p == nullptr)
	   return total;
	...
	countLeafsHelper(p->left, total);
	countLeafsHelper(p->right, total);	
}

template<class T>
void BST<T>::reverseTree() {
	reverseTreeHelper(root);
}

template<class T>
void BST<T>::reverseTreeHelper(BSTNode<T>*& p) {
	if(p == nullptr)
	   return;
	...
	reverseTreeHelper(p->left);
	reverseTreeHelper(p->right);
